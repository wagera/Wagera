...
#define LOG_TAG "AstraUpscaleNative"
#define LOGI(...) __android_log_print(ANDROID_LOG_INFO, LOG_TAG, __VA_ARGS__)

using astraupscale::SrEngine;
using astraupscale::ModelSpec;
...
Java_com_astraupscale_app_NativeSr_nativeGpuAvailable(JNIEnv*, jclass) {
    return astraupscale::gpuAvailable() ? JNI_TRUE : JNI_FALSE;
}

JNIEXPORT jint JNICALL
Java_com_astraupscale_app_NativeSr_nativeCpuCount(JNIEnv*, jclass) {
    int n = ncnn::get_big_cpu_count();
    return n > 0 ? n : ncnn::get_cpu_count();
}

JNIEXPORT jlong JNICALL
Java_com_astraupscale_app_NativeSr_nativeCreate(JNIEnv* env, jclass, jobject assetManager,
...
JNIEXPORT jboolean JNICALL
Java_com_astraupscale_app_NativeSr_nativeUsingGpu(JNIEnv*, jclass, jlong handle) {
    SrEngine* e = reinterpret_cast<SrEngine*>(handle);
    return (e && e->usingGpu()) ? JNI_TRUE : JNI_FALSE;
}

JNIEXPORT void JNICALL
Java_com_astraupscale_app_NativeSr_nativeSetSource(JNIEnv* env, jclass, jlong handle,
...
JNIEXPORT jboolean JNICALL
Java_com_astraupscale_app_NativeSr_nativeProcessBand(JNIEnv* env, jclass, jlong handle,
...
JNIEXPORT jboolean JNICALL
Java_com_astraupscale_app_NativeSr_nativeSetSourceFile(JNIEnv* env, jclass, jlong handle,
...
JNIEXPORT jboolean JNICALL
Java_com_astraupscale_app_NativeSr_nativePrepareStage(JNIEnv*, jclass, jlong handle, jint stage) {
    SrEngine* e = reinterpret_cast<SrEngine*>(handle);
    if (!e) return JNI_FALSE;
...
JNIEXPORT jint JNICALL
Java_com_astraupscale_app_NativeSr_nativeTileSize(JNIEnv*, jclass, jlong handle) {
    SrEngine* e = reinterpret_cast<SrEngine*>(handle);
    return e ? e->tileSize() : 0;
}

JNIEXPORT jstring JNICALL
Java_com_astraupscale_app_NativeSr_nativeLastError(JNIEnv* env, jclass, jlong handle) {
    SrEngine* e = reinterpret_cast<SrEngine*>(handle);
    return env->NewStringUTF(e ? e->lastError().c_str() : "");
}

JNIEXPORT void JNICALL
Java_com_astraupscale_app_NativeSr_nativeDestroy(JNIEnv*, jclass, jlong handle) {
    SrEngine* e = reinterpret_cast<SrEngine*>(handle);
    delete e;
}
